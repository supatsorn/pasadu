	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h2 class="sub-header">สถิติการเบิก-จ่ายตั้งแต่ <?php echo toDateThaiFull($_POST[ "date_from" ]);?> ถึง <?php echo toDateThaiFull($_POST[ "date_to" ]);?></h2>
				<div class="col-sm-12">
...
where date(a.req_date) between '$dt1' and '$dt2'
group by id_name
order by req desc";
